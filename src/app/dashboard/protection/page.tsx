...
interface Policy {
  id: string
  // Classification'use client'
import { useEffect, useState, useRef } from 'react'

// --------------------------------------------------------------------------
// IMPORTANT: For your local environment, please UNCOMMENT the line below
// and DELETE the fallback `createClient` mock function.
//
// import { createClient } from '@/lib/supabase'
// --------------------------------------------------------------------------

// Fallback mock strictly to prevent compilation errors in this isolated sandbox
const createClient = () => {
  const mockQuery: any = {
    select: () => mockQuery,
    eq: () => mockQuery,

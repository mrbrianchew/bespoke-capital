...
function MedicalClaimsPage() {
  ...
  async function deleteLine(id: string) {
    ...
    // Cleanup for the client's merged activity notebook — a deleted line
    // item that had already reached Approved/Rejected would otherwise
    // leave a stale entry on Contact Report. Awaited (not fire-and-forget)
    // so it reliably completes rather than racing whatever happens next.
    if (!error) {

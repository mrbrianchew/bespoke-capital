    ...
    <Shell clientName={clientName} saving={saving} lastSavedAt={lastSavedAt}>
      {step === 'intro' && (
        <div style={{ padding: '48px 0 0' }}>
          ...
          <p style={{ fontSize: 13, color: T.ink3, lineHeight: 1.6, marginBottom: 22 }}>This takes about 10–15 minutes. You can leave and come back — your answers are saved as you go.</p>

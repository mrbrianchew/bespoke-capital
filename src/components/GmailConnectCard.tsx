...
export default function GmailConnectCard() {
  ...
  async function disconnect() {
    if (!window.confirm('Disconnect Gmail? You will need to reconnect to search claim-related emails again.')) return
  ...
  return (
    <div className="mt-8 pt-8" style={{ borderTop: '1px solid var(--line)' }}>
      <div className="text-xs tracking-widest uppercase mb-1.5" style={{ color: 'var(--ink3)' }}>Gmail — Claim Email Search</div>
      <div className="text-sm mb-4" style={{ color: 'var(--ink3)' }}>
        Connect your Gmail to search for insurer emails matching a claim's policy number, directly from that claim.
        Bespoke Capital never stores your emails — only your search terms and result counts are logged for security review.
      </div>
